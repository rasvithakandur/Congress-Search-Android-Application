...
public class BillsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConnectivityManager cm = (ConnectivityManager) getSystemService(BillsActivity.this.CONNECTIVITY_SERVICE);
        ...
        PagerBill adapter = new PagerBill(getSupportFragmentManager(), tabLayout.getTabCount());
    ...
    public boolean onNavigationItemSelected( MenuItem item) {
        ...
        if (id == R.id.item1) {
            ...
            BillsActivity.this.startActivity(in1);
        }
        if (id == R.id.item2) {
