...
import com.congress.congressapp.legislators.LegislatorsDetailActivity;
...
public class LegFavDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.legfavdetail);
        ...
        textViewLegStatename.setText(Html.fromHtml(state));
        ...
        textViewLegState.setText(Html.fromHtml(statename));
        ...
        if (party.equals("R")){
            ...
            textViewLegPartyName.setText("Republican");
            imageLogo.setImageResource(R.drawable.r);
        }else if(party.equals("D")){
            textViewLegPartyName.setText("Democrat");
